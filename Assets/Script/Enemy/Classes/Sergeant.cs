...
public class Sergeant : DefaultEnemy
{
    #region Variables
    ...
    private float common = 25.0f;
    private float uncommon = 40.0f;
    private float rare = 75.0f;
    private float exotic = 90.0f;
    private float legendary = 99.0f;
