...
public class Corporal : DefaultEnemy
{
    #region Variables
    ...
    private float common = 40.0f;
    private float uncommon = 65.0f;
    private float rare = 90.0f;
    private float exotic = 97.0f;
    private float legendary = 99.7f;
